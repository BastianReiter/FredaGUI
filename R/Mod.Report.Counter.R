...
#-------------------------------------------------------------------------------
{
  ...
  div(id = ns("Container"),
      ...
      shiny.semantic::action_button(ns("Btn.ShowAllStages"),
...
#-------------------------------------------------------------------------------
{
  moduleServer(id,
               function(input, output, session)
               {
                  ...
                  R.ShowAllStages <- reactiveVal(FALSE)

                  observe({ R.ShowAllStages(!R.ShowAllStages()) }) %>%
                      bindEvent(input$Btn.ShowAllStages)
                  ...
                  output$CounterTable <- renderReactable({ #req(session$userData$CurationReport())
                                                           ...
                                                           reactable::reactable(data = ReportData.DataSetLevel,
                                                                                pagination = FALSE,
                                                                                ...
                                                                                theme = GetTableTheme(),
                                                                                onClick = "expand",
                                                                                columns = c(GetColumnDefinitions(ReportData = ReportData.DataSetLevel, Level = "DataSetLevel", ShowAllStages = R.ShowAllStages()),
                                                                                                                 ...
                                                                                                                 details = function(index.DataSetLevel)
                                                                                                                           {
                                                                                                                              ...
                                                                                                                              reactable(data = ReportData.TableLevel.SelectedServer,
                                                                                                                                        ...
                                                                                                                                        onClick = "expand",
                                                                                                                                        columns = c(GetColumnDefinitions(ReportData = ReportData.TableLevel.SelectedServer, Level = "TableLevel", ShowAllStages = R.ShowAllStages()),
                                                                                                                                                                                    ...
                                                                                                                                                                                    if (SelectedServer == "All")
                                                                                                                                                                                    {
                                                                                                                                                                                        ...
                                                                                                                                                                                        return(reactable(data = ReportData.TableLevel.SelectedTable,
                                                                                                                                                                                                         ...
                                                                                                                                                                                                         theme = GetTableTheme(Mod.Style = list(fontSize = "12px"),
                                                                                                                                                                                                                               Mod.HeaderStyle = list(display = "none"),
                                                                                                                                                                                                                               Mod.RowStyle = list(height = "30px")),
                                                                                                                                                                                                         columns = c(GetColumnDefinitions(ReportData = ReportData.TableLevel.SelectedTable, Level = "SubtableLevel", ShowAllStages = R.ShowAllStages()),
